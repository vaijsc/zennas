...
from timm_monet.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame
from timm_monet.layers.non_local_attn import BilinearAttnTransform
from timm_monet.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
from timm_monet.layers.norm_act import (
    BatchNormAct2d,
    SyncBatchNormAct,
...
# NOTE: By default, any modules from timm_monet.models.layers that we want to treat as leaf modules go here
# BUT modules from timm_monet.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from timm_monet.layers import InplaceAbn
