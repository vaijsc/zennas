...
from utils.data import iCIFAR100, iIMAGENET_R, iIMAGENET_A, iCUB, iDomainNet, iCIFAR10, iOfficeHome, iOfficeHome_90norm, iOfficeHome_80norm, iOfficeHome_90, iPACS_80norm, iPACS_80, iVLCS_80norm, iVLCS_80
...
def _get_idata(dataset_name, args=None):
    ...
    if name == 'cifar100':
        ...
        return iOfficeHome_90(args)
    elif name == 'office_80norm':
        return iOfficeHome_80norm(args)
    elif name == 'office_90norm':
        return iOfficeHome_90norm(args)
    elif name == 'pacs_80norm':
        return iPACS_80norm(args)
    elif name == 'pacs_80':
        return iPACS_80(args)
    elif name == 'vlcs_80norm':
        return iVLCS_80norm(args)
    elif name == 'vlcs_80':
        return iVLCS_80(args)
    else:
