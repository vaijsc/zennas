...
class LearningRateScheduler():
    ...
    def get_lr(self, num_received_training_instances=None):
        ...
        assert stop_instances > warmup_instances, f"stop_instances ({stop_instances}) should be greater than warmup_instances ({warmup_instances}), num_training_instances: {self.num_training_instances}, stop_epoch: {self.stop_epoch}, num_training_instances = {self.num_training_instances}, warmup_epoch: {self.warmup_epoch}"
